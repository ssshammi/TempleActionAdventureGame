...
using Articy.The_Key_Of_The_Nile;
using Articy.The_Key_Of_The_Nile.Features;
using Articy.Unity;
...
namespace Articy.The_Key_Of_The_Nile.Templates
{
    ...
    public class DefaultMainCharacterTemplateTemplate : IArticyBaseObject, IPropertyProvider
    {
        ...
        public Articy.The_Key_Of_The_Nile.Features.DefaultExtendedCharacterFeatureFeature DefaultExtendedCharacterFeature
        {
            get
            {
        ...
        public Articy.The_Key_Of_The_Nile.Features.DefaultBasicCharacterFeatureFeature DefaultBasicCharacterFeature
        {
            get
            {
        ...
        {
            Articy.The_Key_Of_The_Nile.Templates.DefaultMainCharacterTemplateTemplate newClone = ((Articy.The_Key_Of_The_Nile.Templates.DefaultMainCharacterTemplateTemplate)(aClone));
            if ((DefaultExtendedCharacterFeature != null))
            {
                newClone.DefaultExtendedCharacterFeature = ((Articy.The_Key_Of_The_Nile.Features.DefaultExtendedCharacterFeatureFeature)(DefaultExtendedCharacterFeature.CloneObject(newClone, aFirstClassParent)));
            }
            if ((DefaultBasicCharacterFeature != null))
            {
                newClone.DefaultBasicCharacterFeature = ((Articy.The_Key_Of_The_Nile.Features.DefaultBasicCharacterFeatureFeature)(DefaultBasicCharacterFeature.CloneObject(newClone, aFirstClassParent)));
            }
        ...
        {
            Articy.The_Key_Of_The_Nile.Templates.DefaultMainCharacterTemplateTemplate clone = new Articy.The_Key_Of_The_Nile.Templates.DefaultMainCharacterTemplateTemplate();
