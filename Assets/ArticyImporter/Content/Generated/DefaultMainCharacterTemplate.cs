...
namespace Articy.The_Key_Of_The_Nile
{
    ...
    public class DefaultMainCharacterTemplate : Entity, IEntity, IPropertyProvider, IObjectWithFeatureDefaultExtendedCharacterFeature, IObjectWithFeatureDefaultBasicCharacterFeature
    {
        ...
        private static Articy.The_Key_Of_The_Nile.Templates.DefaultMainCharacterTemplateTemplateConstraint mConstraints = new Articy.The_Key_Of_The_Nile.Templates.DefaultMainCharacterTemplateTemplateConstraint();
        
        public Articy.The_Key_Of_The_Nile.Templates.DefaultMainCharacterTemplateTemplate Template
        {
            get
            {
        ...
        public static Articy.The_Key_Of_The_Nile.Templates.DefaultMainCharacterTemplateTemplateConstraint Constraints
        {
            get
            {
                return mConstraints;
        ...
        protected override void CloneProperties(object aClone, Articy.Unity.ArticyObject aFirstClassParent)
        {
            ...
            if ((Template != null))
            {
                newClone.Template = ((Articy.The_Key_Of_The_Nile.Templates.DefaultMainCharacterTemplateTemplate)(Template.CloneObject(newClone, aFirstClassParent)));
            }
