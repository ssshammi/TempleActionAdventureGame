...
namespace Articy.The_Key_Of_The_Nile
{
    ...
    public class DefaultSupportingCharacterTemplate : Entity, IEntity, IPropertyProvider, IObjectWithFeatureDefaultBasicCharacterFeature
    {
        ...
        private static Articy.The_Key_Of_The_Nile.Templates.DefaultSupportingCharacterTemplateTemplateConstraint mConstraints = new Articy.The_Key_Of_The_Nile.Templates.DefaultSupportingCharacterTemplateTemplateConstraint();
        
        public Articy.The_Key_Of_The_Nile.Templates.DefaultSupportingCharacterTemplateTemplate Template
        {
            get
            {
        ...
        public static Articy.The_Key_Of_The_Nile.Templates.DefaultSupportingCharacterTemplateTemplateConstraint Constraints
        {
            get
            {
                return mConstraints;
        ...
        protected override void CloneProperties(object aClone, Articy.Unity.ArticyObject aFirstClassParent)
        {
            ...
            if ((Template != null))
            {
                newClone.Template = ((Articy.The_Key_Of_The_Nile.Templates.DefaultSupportingCharacterTemplateTemplate)(Template.CloneObject(newClone, aFirstClassParent)));
            }
